<template>
  ...
  >
    <div class="header-navigation__subcategories-inner">
      <div class="subcategory_inner_dv">
        <div
        ...
        >
          ...
          >
            <h2 class="sf-heading sf-heading--left sf-heading sf-heading--left h5 subcategory_h2">
              {{ catLvl1.name }}
            </h2>
          </SfLink>
...
.cstm_nav_layout .header-navigation__subcategories {
    width: 100%;
...
.cstm_nav_layout .header-navigation__subcategories-inner {
  align-items: start;
}
.cstm_nav_layout .subcategory_inner_dv {
    width: 100%;
}
.cstm_nav_layout .header-navigation__subcategory {
    margin-bottom: 38px;
}
.cstm_nav_layout .header-navigation__subcategory .subcategory_h2 {
