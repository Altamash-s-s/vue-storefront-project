  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      $(document).ready(function () {
        ...
        console.log(url + " Sales page");
        if(url === 'http://localhost:3000/default/sale.html')
        {
          $('.product-price').css('display','block');
          $('.filters.desktop-only').addClass('abc');
        }    
        else {
          $('.product-price').css('display','hide');
          $('.filters__buttons').css('display','block');
        }
